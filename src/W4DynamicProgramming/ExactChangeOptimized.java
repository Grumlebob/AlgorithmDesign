 ...
 * */
public class ExactChangeOptimized {
    ...
    private static class Solver {
        ...
        public static int[] bottomUp(Set<Integer> coins, int target) {
            ...
            List<Integer> memoization = new ArrayList<>(Collections.nCopies(maxPossibleTargets + 1, Integer.MAX_VALUE));
            ...
            for (int coin : coins) {
                ...
                for (int currentTarget = 0; currentTarget <= maxPossibleTargets-coin; currentTarget++) {
                    ...
                    if (memoization.get(currentTarget) != Integer.MAX_VALUE) {
                        ...
                        memoization.set(newTarget, Math.min(memoization.get(newTarget), memoization.get(currentTarget) + 1));
                    }
                }
            }
